---
title: "clusterctl Configuration File"
linkTitle: "clusterctl Config"
weight: 60
description: |
  Documentation about the clusterctl configuration file.
migration: |
  Last import date: 10-21-2022
aliases:
- /clusterctl/configuration
- /clusterctl/configuration.html
---
...
The `clusterctl` CLI is designed to work with providers implementing the [clusterctl Provider Contract](/docs/provider/contract/clusterctl).
...
See [clusterctl Provider Contract](/docs/provider/contract/clusterctl) for instructions about how to set up a provider repository.
...
Follow [this](/docs/reference/clusterctl#avoiding-github-rate-limiting)
...
[Build artifacts locally](/docs/developer/test/clusterctl#build-artifacts-locally).
...
[provider version pinning](../clusterctl/init.md#provider-version) when executing clusterctl commands.
