---
title: "clusterctl move"
linkTitle: "move"
description: |
  Move Cluster API objects and all their dependencies between management clusters.
migration: |
  Last import date: 10-21-2022
aliases:
- /clusterctl/commands/move
- /clusterctl/commands/move.html
---
